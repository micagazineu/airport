...
const runSingleRequest = async function (
  ...
  try {
    ...
    interpolateVars(request, envVariables, runtimeVariables, processEnvVars, externalSecretVariables);
    ...
    let requestContentType = getContentType(request?.headers);
    ...
    return {
      ...
      request: {
        ...
        url: request.url,
        headers: request.headers,
        data: requestContentType?.includes("html") || requestContentType?.includes("image")
      ...
      response: {
        ...
        data: responseContentType?.includes("html") || responseContentType?.includes("image")
